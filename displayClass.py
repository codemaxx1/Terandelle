...
class Display:
    ...
    def bootup(self):
        ...
        for i in range(round(self.displayWidth*self.displayHeight/500)):
            ...
            #loading indicator
            self.drawRect(0, self.displayHeight-15, round(i*500/self.displayHeight), self.displayHeight, 1, 0)
